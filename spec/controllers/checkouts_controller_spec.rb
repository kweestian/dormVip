  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved checkout as @checkout" do
        ...
        post :create, {:checkout => { "order_id" => "invalid value" }}, valid_session
        assigns(:checkout).should be_a_new(Checkout)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested checkout" do
        ...
        Checkout.any_instance.should_receive(:update).with({ "order_id" => "" })
        put :update, {:id => checkout.to_param, :checkout => { "order_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the checkout as @checkout" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Checkout.any_instance.stub(:save).and_return(false)
        put :update, {:id => checkout.to_param, :checkout => { "order_id" => "invalid value" }}, valid_session
        assigns(:checkout).should eq(checkout)
      end
